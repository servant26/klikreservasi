...
<div class="content-header">
  <div class="container">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Foto Kunjungan Perpustakaan</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}">Back to Dashboard</a></li>
          <li class="breadcrumb-item active">Foto Kunjungan Perpustakaan</li>
        </ol>
      </div>
    </div>
  </div>
...
<div class="container mb-5">
  ...
  <div id="carouselReservasi" class="carousel slide mb-4" data-bs-ride="carousel">
    ...
    <a href="{{ route('user.kunjungan') }}" class="btn btn-primary">Next</a>
